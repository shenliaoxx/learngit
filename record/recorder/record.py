...
class BatchVideoRecorder:
    def __init__(self, output_dir="videos", width=640, height=480, fps=30):
        ...
        self.motions = [
            ...
            {"name": "abduction_all_fingers", "description": "所有手指外展", "duration": 5},
            {"name": "fist", "description": "握拳", "duration": 5},
            {"name": "thumbs_up", "description": "点赞动作", "duration": 5},
            {"name": "pointing", "description": "指向动作", "duration": 5},
            {"name": "large_grasp", "description": "大范围抓握", "duration": 5},
            {"name": "writing_grasp", "description": "书写抓握", "duration": 5},
            {"name": "parallel_extension_grasp", "description": "平行伸展抓握", "duration": 5}
        ]
